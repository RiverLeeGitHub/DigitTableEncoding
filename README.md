...
## Introduction
DigitTable Encoding: Randomly extends 4 directions of a digit table, determines the position of each value of sequence. Tracks from previous place to the next were taken for codes.<br>
